...
% model parameters
%%
data = load('./uci/airfoil/airfoil.mat');
...
opts.Ms = 10 ; opts.partitionCriterion = partitionCriterion ;
...
[mu_dGP,s2_dGP,t_dGP_predict] = aggregation_predict(x,models,criterion) ;
